"""LLM draft jobs: RQ queue `sv_llm`, Redis active pointer `sv:llm_draft_active:{report_id}`."""
...
from src.llm_client import chat as llm_chat
from src.llm_client import default_model as llm_default_model
...
LLM_QUEUE = "sv_llm"
_ACTIVE_KEY_FMT = "sv:llm_draft_active:{rid}"
...
def enqueue_llm_draft(report_id: int, physician_id: int | None) -> dict[str, Any]:
    """Enqueue or return an already queued/started job for this report."""
